...
import { addBanner, getBanner,deleteBanner, getAllBanners, updateBanner } from "../controllers/banners.controller.js";
import { upload } from "../middleware/multer.middleware.js";

const router = Router();

router.route("/add-banner").post(upload.single("banner_img"), addBanner);
router.route("/update-banner/:bannerID").put(updateBanner);
