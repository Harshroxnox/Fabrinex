  ...
  return (
    ...
    <div className="max-w-6xl mx-auto p-4 font-sans">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <d iv className="flex flex-row md:flex-col gap-2 md:w-24 ">
          {[1, 2, 3].map((item) => (
            <div 
              key={item} 
        ...
        {/* Middle - Main Image */}
        <div className="bg-gray-100 rounded-2xl items-center justify-center md:flex-1 h-[400px]">
          <img 
        ...
        <div className="md:w-80 space-y-6">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">ONE LIFE GRAPHIC T-SHIRT</h1>
            ...
            <div className="flex items-center mt-4">
              ...
              <span className="ml-2 text-sm bg-red-100 text-red-600 px-2 py-1 rounded">-40%</span>
            </div>
