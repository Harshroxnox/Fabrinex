    ...
    const fetchPurchases = async () => {
        ...
        try {
            switch (searchQuery.type) {
                case 'seller':
                    console.log("Searching by seller:", searchQuery.term);
                    result = await searchPurchasesBySeller({ supplier: "PR" });
                    break;
                case 'dateRange':
        ...
        <div className="purchases-container">
            ...
            {paginationInfo && paginationInfo.totalPages > 1 && (
                <div className="pagination-controls">
                    ...
                    <button onClick={() => setCurrentPage(p => Math.min(paginationInfo.totalPages, p + 1))} disabled={currentPage === paginationInfo.totalPages}>
                        Next
                    </button>
                </div>
            )}
